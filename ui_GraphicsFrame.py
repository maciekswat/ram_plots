...
#
# Created: Mon Apr 25 19:13:53 2016
...
class Ui_GraphicsFrame(object):
    def setupUi(self, GraphicsFrame):
        ...
        self.animate_PB = QtGui.QPushButton(GraphicsFrame)
        self.animate_PB.setObjectName(_fromUtf8("animate_PB"))
        self.horizontalLayout_6.addWidget(self.animate_PB)
        self.anim_dir_PB = QtGui.QPushButton(GraphicsFrame)
        self.anim_dir_PB.setObjectName(_fromUtf8("anim_dir_PB"))
        self.horizontalLayout_6.addWidget(self.anim_dir_PB)
        self.anim_dir_LE = QtGui.QLineEdit(GraphicsFrame)
        self.anim_dir_LE.setObjectName(_fromUtf8("anim_dir_LE"))
        self.horizontalLayout_6.addWidget(self.anim_dir_LE)
        self.verticalLayout.addLayout(self.horizontalLayout_6)
        self.horizontalLayout_7 = QtGui.QHBoxLayout()
        self.horizontalLayout_7.setObjectName(_fromUtf8("horizontalLayout_7"))
        self.label_2 = QtGui.QLabel(GraphicsFrame)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.horizontalLayout_7.addWidget(self.label_2)
        self.rot_axis_LE = QtGui.QLineEdit(GraphicsFrame)
        self.rot_axis_LE.setObjectName(_fromUtf8("rot_axis_LE"))
        self.horizontalLayout_7.addWidget(self.rot_axis_LE)
    ...
    def retranslateUi(self, GraphicsFrame):
        ...
        self.animate_PB.setText(_translate("GraphicsFrame", "Animate", None))
        self.anim_dir_PB.setText(_translate("GraphicsFrame", "Anim. Dir", None))
        self.label_2.setText(_translate("GraphicsFrame", "Rotation axis", None))
        self.rot_axis_LE.setText(_translate("GraphicsFrame", "0,1,0", None))
