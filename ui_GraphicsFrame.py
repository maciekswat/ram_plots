...
class Ui_GraphicsFrame(object):
    def setupUi(self, GraphicsFrame):
        ...
        self.pos_dir_RB = QtGui.QRadioButton(GraphicsFrame)
        self.pos_dir_RB.setObjectName(_fromUtf8("pos_dir_RB"))
        self.horizontalLayout_2.addWidget(self.pos_dir_RB)
    ...
    def retranslateUi(self, GraphicsFrame):
        ...
        self.pos_dir_RB.setText(_translate("GraphicsFrame", "+", None))
